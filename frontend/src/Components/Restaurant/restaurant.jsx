    ...
    return (
        <ChakraProvider>
            <div>
                ...
                <TabOptions googleRevs={reviews} openingHours={openingHours} optionsData={optionsData} phoneNumber={phone_number} mapLink={map_link} licenseno={licenseno} placeId={placeId} address={address} website={website}/>
